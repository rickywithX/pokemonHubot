...
module.exports = (robot) => {
    ...
    robot.respond(/ウルトラネクロズマ/i, (msg) => {
        msg.send('ウルトラネクロズマのデータです！' + '\n' + '超/竜' + '  ' + '97-167-97-167-97-129-754' + '  ' + 'ブレインフォース' + ' ' + '\n' + 'https://yakkun.com/sm/zukan/n800u')
    });
    ...
    robot.respond(/カプ・ブルル/i, (msg) => {
        msg.send('カプ・ブルルのデータです！' + '\n' + '草/妖' + '  ' + '70 - 130 - 115 - 85 - 95 - 75 - 570' + ' ' + 'グラスメーカー/*テレパシー' + '\n' + 'https://yakkun.com/sm/zukan/n787')
    });
